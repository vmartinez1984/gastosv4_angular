...
- [X] Corregir el borrado de detalles de la version -> https://vmartinez1984.github.io/gastosv4_angular/#/versiones/4/detalles
- [ ] Lista de detalles, agregar columna mensual y quincenal.
- [ ] Lista de versiones agregar el total de la versión.
- [X] Cambiar el sweet alert de formulario por el nativo de material
