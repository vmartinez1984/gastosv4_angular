...
export class PeriodoService {
  obtenerPresupuestos(id: number): Observable<PresupuestoDelPeriodoDto[]> {
    return this.httpClient.get<PresupuestoDelPeriodoDto[]>(this.url + id + "/Presupuestos")
  }

  agregarTransaccion(periodoId: number, transaccion: TransaccionDtoIn):Observable<any> {
    return this.httpClient.post<any>(this.url + periodoId + "/Transacciones", transaccion)
  }
